...
export default function Step31() {
  ...
  return (
    <div
      ...
      className="flex flex-col items-center w-full h-full bg-white overflow-x-hidden"
    >
      <div className="w-full h-3" />
      <div
        className="flex flex-col flex-1 justify-center items-center w-full max-w-[664px] mx-auto px-4 sm:px-6 mt-2 mb-2"
        style={{ maxWidth: "100%" }}
      >
        <div className="flex flex-col flex-grow justify-center items-center max-w-full">
          ...
          <div className="flex flex-col relative items-center mt-5">
            <div className="w-full max-w-[400px] mt-10" style={{ width: "400px", maxWidth: "100%" }}>
              <div
              ...
              >
                <div className="flex items-center mt-0" style={{ marginTop: "0px" }}>
          ...
          >
            {["we do not send spam", "we do not share your email with 3rd parties"].map((text) => (
              <div key={text} className="flex items-start gap-3">
                ...
                <span className="font-medium text-[13px] leading-[18px] font-[Montserrat,sans-serif] whitespace-pre-wrap">{text}</span>
              </div>
            ))}
          </div>
          ...
          <svg
            ...
            viewBox="0 0 388 87"
            className="mt-8"
            style={{ width: "100%", maxWidth: 323, height: "auto", mixBlendMode: "darken" }}
          >
        ...
        {/* Sticky button + terms */}
        <div
          className="flex flex-col items-center gap-5 bg-white w-full"
          style={{ position: "sticky", bottom: 0 }}
        >
          <button
            disabled={!isValid || saving}
            onClick={handleContinue}
            className="flex justify-center items-center rounded-lg transition-all duration-150 mt-4 w-full max-w-[327px]"
            style={{
              padding: "13px 36px",
