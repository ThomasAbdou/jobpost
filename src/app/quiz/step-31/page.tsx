...
export default function Step31() {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col flex-1 min-h-0 overflow-y-auto items-center w-full">
        <div
          className="flex flex-col flex-grow justify-center items-center w-full max-w-[664px] mx-auto px-4 sm:px-6 mt-8 mb-[52px]"
          style={{ maxWidth: "100%" }}
        >
          <div className="flex flex-col flex-grow justify-center items-center max-w-full w-full">
            ...
            {/* Email input */}
            <div className="flex flex-col relative items-center mt-5 w-full">
              <div className="w-full mt-10" style={{ maxWidth: 400 }}>
                <div
            ...
            <img
              ...
              alt="Product Hunt"
              style={{ width: 175, height: 39, marginTop: 52 }}
            />
            ...
            <svg
              ...
              fill="none"
              viewBox="0 0 388 87"
              style={{ width: 323, height: 87, marginTop: 32, mixBlendMode: "darken", maxWidth: "100%" }}
            >
